...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5359);
...
exports.Z = void 0;
var React = _interopRequireWildcard(__webpack_require__(5359));
var _createSvgIcon = _interopRequireDefault(__webpack_require__(4938));
var _jsxRuntime = __webpack_require__(5893);
...
var _utils = __webpack_require__(6426);
...
var emotion_element_c39617d8_browser_esm = __webpack_require__(3562);
...
var defaultTheme = __webpack_require__(8824);
...
var styled = __webpack_require__(4445);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(8686), __webpack_require__.b);
 ...
 * LICENSE file in the root directory of this source tree.
 */
__webpack_require__(7418);var f=__webpack_require__(5359),g=60103;exports.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h=Symbol.for;g=h("react.element");exports.Fragment=h("react.fragment")}var m=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n=Object.prototype.hasOwnProperty,p={key:!0,ref:!0,__self:!0,__source:!0};
...
var external_cgpv_reactDOM_default = /*#__PURE__*/__webpack_require__.n(external_cgpv_reactDOM_namespaceObject);
// EXTERNAL MODULE: external "cgpv.react"
var external_cgpv_react_ = __webpack_require__(5359);
var external_cgpv_react_default = /*#__PURE__*/__webpack_require__.n(external_cgpv_react_);
...
;// CONCATENATED MODULE: ./node_modules/reactstrap/esm/utils.js
...
var Element = (typeof window === "undefined" ? "undefined" : utils_typeof(window)) === 'object' && window.Element || function () {};
...
function isReactRefObj(target) {
  if (target && utils_typeof(target) === 'object') {
...
;// CONCATENATED MODULE: ./node_modules/reactstrap/esm/CloseButton.js
var CloseButton_excluded = ["className", "cssModule", "variant", "innerRef"];
function CloseButton_extends() { CloseButton_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return CloseButton_extends.apply(this, arguments); }
...
function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = CloseButton_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
...
function CloseButton(props) {
  var className = props.className,
    ...
    attributes = _objectWithoutProperties(props, CloseButton_excluded);
  var classes = mapToCssModules(classnames_default()(className, 'btn-close', variant && "btn-close-".concat(variant)));
  return /*#__PURE__*/external_cgpv_react_default().createElement("button", CloseButton_extends({
    ref: innerRef,
    type: "button",
    className: classes
  }, _objectSpread({
...
;// CONCATENATED MODULE: ./node_modules/reactstrap/esm/Button.js
...
function Button(props) {
  var onClick = (0,external_cgpv_react_.useCallback)(function (e) {
    if (props.disabled) {
      e.preventDefault();
      return;
    }
  ...
  if (close) {
    return /*#__PURE__*/external_cgpv_react_default().createElement(esm_CloseButton, attributes);
  }
  var btnOutlineColor = "btn".concat(outline ? '-outline' : '', "-").concat(color);
  var classes = mapToCssModules(classnames_default()(className, 'btn', btnOutlineColor, size ? "btn-".concat(size) : false, block ? 'd-block w-100' : false, {
    active: active,
  ...
  return /*#__PURE__*/external_cgpv_react_default().createElement(Tag, Button_extends({
...
/* harmony default export */ const TransitionGroupContext = (external_cgpv_react_default().createContext(null));
...
var Transition = /*#__PURE__*/function (_React$Component) {
    ...
    if (nextStatus !== null) {
      ...
      if (nextStatus === ENTERING) {
        if (this.props.unmountOnExit || this.props.mountOnEnter) {
          var node = this.props.nodeRef ? this.props.nodeRef.current : external_cgpv_reactDOM_default().findDOMNode(this); // https://github.com/reactjs/react-transition-group/pull/749
  ...
  _proto.performEnter = function performEnter(mounting) {
    ...
    var _ref2 = this.props.nodeRef ? [appearing] : [external_cgpv_reactDOM_default().findDOMNode(this), appearing],
        maybeNode = _ref2[0],
  ...
  _proto.performExit = function performExit() {
    ...
    var timeouts = this.getTimeouts();
    var maybeNode = this.props.nodeRef ? undefined : external_cgpv_reactDOM_default().findDOMNode(this); // no exit animation skip right to EXITED
  ...
  _proto.onTransitionEnd = function onTransitionEnd(timeout, handler) {
    ...
    var node = this.props.nodeRef ? this.props.nodeRef.current : external_cgpv_reactDOM_default().findDOMNode(this);
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      external_cgpv_react_default().createElement(TransitionGroupContext.Provider, {
        value: null
      }, typeof children === 'function' ? children(status, childProps) : external_cgpv_react_default().cloneElement(external_cgpv_react_default().Children.only(children), childProps))
    );
  };

  return Transition;
}((external_cgpv_react_default()).Component);
...
;// CONCATENATED MODULE: ./node_modules/reactstrap/esm/Collapse.js
...
var Collapse_excluded = ["tag", "horizontal", "isOpen", "className", "navbar", "cssModule", "children", "innerRef"];
var _transitionStatusToCl;
function Collapse_extends() { Collapse_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return Collapse_extends.apply(this, arguments); }
...
function _possibleConstructorReturn(self, call) { if (call && (Collapse_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return Collapse_assertThisInitialized(self); }
...
var Collapse_propTypes = Collapse_objectSpread(Collapse_objectSpread({}, esm_Transition.propTypes), {}, {
  ...
  cssModule: (prop_types_default()).object,
  innerRef: prop_types_default().shape({
    current: (prop_types_default()).object
  })
});
var defaultProps = Collapse_objectSpread(Collapse_objectSpread({}, esm_Transition.defaultProps), {}, {
  horizontal: false,
  isOpen: false,
  appear: false,
  enter: true,
...
var Collapse = /*#__PURE__*/function (_Component) {
  ...
  function Collapse(props) {
    ...
    _this.nodeRef = props.innerRef || /*#__PURE__*/external_cgpv_react_default().createRef();
    ['onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited'].forEach(function (name) {
      _this[name] = _this[name].bind(Collapse_assertThisInitialized(_this));
    });
    return _this;
  }
  Collapse_createClass(Collapse, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
        ...
        otherProps = Collapse_objectWithoutProperties(_this$props, Collapse_excluded);
      var dimension = this.state.dimension;
      var transitionProps = pick(otherProps, TransitionPropTypeKeys);
      var childProps = omit(otherProps, TransitionPropTypeKeys);
      return /*#__PURE__*/external_cgpv_react_default().createElement(esm_Transition, Collapse_extends({}, transitionProps, {
        "in": isOpen,
        ...
        var classes = mapToCssModules(classnames_default()(className, horizontal && 'collapse-horizontal', collapseClass, navbar && 'navbar-collapse'), cssModule);
        var style = dimension === null ? null : Collapse_defineProperty({}, horizontal ? 'width' : 'height', dimension);
        return /*#__PURE__*/external_cgpv_react_default().createElement(Tag, Collapse_extends({}, childProps, {
  ...
  return Collapse;
}(external_cgpv_react_.Component);
...
var header = __webpack_require__(7717);
...
var header_update = injectStylesIntoStyleTag_default()(header/* default */.Z, options);
...
function Header() {
    ...
    var useTranslation = app_cgpv.useTranslation;
    var t = useTranslation().t;
    var _b = __read((0,external_cgpv_react_.useState)(false), 2), collapse = _b[0], setCollapse = _b[1];
    ...
    return ((0,jsx_runtime.jsx)("header", { className: "header", children: (0,jsx_runtime.jsx)("div", { className: "container-fluid", children: (0,jsx_runtime.jsx)("div", { className: "row align-items-center", children: (0,jsx_runtime.jsx)("div", { className: "col-12 header-nav-col", children: (0,jsx_runtime.jsxs)("nav", { className: "navbar navbar-light navbar-expand-lg header-nav", children: [(0,jsx_runtime.jsx)("a", { href: "", target: "_blank", "aria-label": t('nav.logoLinktext'), children: (0,jsx_runtime.jsx)("img", { src: "assets/img/GeoDotCaBanner.jpg", alt: t('nav.logotext') }) }), (0,jsx_runtime.jsx)(esm_Button, { onClick: toggle, id: "toggler", className: "navbar-toggler", type: "button", "data-toggle": "collapse", "aria-controls": "navbar-menu", "aria-expanded": collapse, "aria-label": "Toggle navigation", children: (0,jsx_runtime.jsx)("span", { className: collapse ? 'navbar-toggler-icon nav-bar-open' : 'navbar-toggler-icon nav-bar-closed' }) }), (0,jsx_runtime.jsx)(esm_Collapse, { isOpen: collapse, className: "navbar-collapse navbar-wrap", children: (0,jsx_runtime.jsxs)("ul", { className: "navbar-nav ml-auto", children: [(0,jsx_runtime.jsx)("li", { className: "nav-item", children: (0,jsx_runtime.jsx)("button", { type: "button", onClick: gotoHome, children: t('nav.search') }) }), (0,jsx_runtime.jsx)("li", { className: "nav-item", children: (0,jsx_runtime.jsx)("button", { id: "myMapBtn", type: "button", children: t('nav.mymap') }) }), (0,jsx_runtime.jsx)("li", { className: "nav-item", children: (0,jsx_runtime.jsx)("button", { type: "button", lang: t('nav.language.htmllangcode'), children: t('nav.language.name') }) })] }) })] }) }) }) }) }));
}
